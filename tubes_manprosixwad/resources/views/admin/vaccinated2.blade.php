    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="col-5 pt-5">
            <h3>Sertifikat Vaksin 1 :</h3> 
            <img src="{{ asset('storage/' . $user->sertif1) }}" style="height:450px;width:800px; "alt="">
            <h3>Sertifikat Vaksin 2 :</h3>
            <img src="{{ asset('storage/' . $user->sertif2) }}" style="height:450px;width:800px; " alt="">
        </div>
        @endforeach
        </div>
      </main>
