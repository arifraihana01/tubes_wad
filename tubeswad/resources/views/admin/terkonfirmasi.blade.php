    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h4">Penentuan Jadwal Vaksin 2 Bpk/Ibu {{ $user->name }}</h1>
        </div>
        ...
        <div class="col-5 pt-5">
            <form action="/updateterkonfirmasi" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    <label for="sertif1" class="form-label">Upload Sertifikat Pertama</label>
                    <input type="file" class="form-control @error ('sertif1') is-invalid @enderror" id="sertif1" name="sertif1"  required>
                    @error('sertif1')
